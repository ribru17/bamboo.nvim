...
ble-face -s cmdinfo_cd_cdpath fg=#95bbda,bg=black,italic
ble-face -s command_alias fg=blue
ble-face -s command_builtin fg=#d99058
ble-face -s command_directory fg=#95bbda
...
ble-face -s filename_directory fg=#95bbda
...
ble-face -s filename_setuid fg=black,bg=#d99058,underline
...
ble-face -s syntax_expr fg=#c5b0d4
ble-face -s syntax_function_name fg=blue
ble-face -s syntax_glob fg=#d99058
...
ble-face -s syntax_tilde fg=#c5b0d4
ble-face -s syntax_varname fg=none
ble-face -s varname_array fg=#d99058
ble-face -s varname_empty fg=#d99058
ble-face -s varname_export fg=#d99058
ble-face -s varname_expr fg=#d99058
ble-face -s varname_hash fg=#d99058
ble-face -s varname_number fg=none
ble-face -s varname_readonly fg=#d99058
ble-face -s varname_transform fg=#d99058
