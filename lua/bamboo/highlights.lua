...
if vim.api.nvim_call_function('has', { 'nvim-0.8' }) == 1 then
  hl.treesitter = {
    ...
    ['@parameter.builtin'] = { link = '@variable.parameter.builtin' },
    ...
    ['@text.uri'] = { link = '@string.special.url' },
