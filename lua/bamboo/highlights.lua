...
hl.treesitter = {
  ...
  ['@markup.underline'] = { fg = c.orange, underline = true },
...
hl.langs.markdown = {
  ...
  markdownH1 = { fg = rainbows.red, bold = true },
  markdownH2 = { fg = rainbows.orange, bold = true },
  markdownH3 = { fg = rainbows.yellow, bold = true },
  markdownH4 = { fg = rainbows.green, bold = true },
  markdownH5 = { fg = rainbows.cyan, bold = true },
  markdownH6 = { fg = rainbows.blue, bold = true },
  ...
  markdownStrike = { fg = c.orange, strikethrough = true },
